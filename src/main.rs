...
// Note: Each of these threads can error out due to the not being able to send back. Doing so will end the thread, which has the side-effect of not having threads run for people who quit
